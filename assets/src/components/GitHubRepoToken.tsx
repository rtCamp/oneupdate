		...
		<Card style={ { marginTop: '20px' } }>
			...
			<CardBody>
				<TextControl
					...
					help={ __(
						'Enter your GitHub Personal Access Token to authenticate with the GitHub API. This token should have permissions to access your public/private repositories.',
						'oneupdate'
					) }
